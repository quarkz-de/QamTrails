...
var
  BaseFolder: String;
begin
  BaseFolder := ApplicationSettings.MainCollectionFolder + '\';
  Result := AFilename;
  if CompareText(ApplicationSettings.MainCollectionFolder, LeftStr(AFilename, Length(BaseFolder))) = 0 then
...
begin
  if IsRelativePath(AFilename) then
    Result := TPath.Combine(ApplicationSettings.MainCollectionFolder, AFilename)
  else
    Result := AFilename;
end;
